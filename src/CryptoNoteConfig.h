...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(1410000000000000) ;
...
const char     CRYPTONOTE_NAME[]                             = "bbcoin";
...
const int      P2P_DEFAULT_PORT                              = 14100;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 14101;
